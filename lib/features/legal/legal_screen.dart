...
class LegalScreen extends StatelessWidget {
  ...
  static const List<LegalSection> terms = [
    ...
    LegalSection('제6조 (유료 서비스)',
        '리포트 열람 등 일부 기능은 유료로 제공될 수 있습니다. 유료 상품의 가격·내용은 결제 전 화면에 표시됩니다.'),
    LegalSection('제6조의2 (환불 정책)',
        '결제 후 아직 이용하지 않은 유료 상품은 관련 법령(전자상거래법 등) 및 앱 마켓 정책에 따라 환불받을 수 있습니다. 이미 열람한 리포트 등 사용을 개시한 디지털 콘텐츠는 청약철회가 제한될 수 있으며, 환불은 앱 마켓(App Store·Google Play)의 결제 수단을 통해 처리됩니다.'),
